...
int isLessOrEqual(int x, int y) {
  int xPositive = !((x >> 31) & 0x1);
  int yPositive = !((y >> 31) & 0x1);
  int xPosAndyNeg = xPositive & (!yPositive);
  int xNegAndyPos = (!xPositive) & yPositive;
  int xyEqual = !(x ^ y);
  int xyPosOrNegAndxLessy = ((x + (~y + 1)) >> 31) & 0x1;
...
int howManyBits(int x) {
  ...
  leftmost_one >>= 1;
  leftmost_one += 1;
  X_0 = (leftmost_one | (leftmost_one >> 16));
  X_0 |= X_0 >> 8;
  X_0 |= X_0 >> 4;
  X_0 |= X_0 >> 2;
  X_0 >>= 1;
  ...
  X_1 = leftmost_one | (leftmost_one << 1);
  X_1 |= X_1 << 4;
  X_1 |= X_1 << 8;
  X_1 |= X_1 << 16;
  X_1 >>= 31;
  ...
  X_2 = leftmost_one | (leftmost_one << 8);
  X_2 |= X_2 << 16;
  X_2 |= X_2 << 2;
  X_2 |= X_2 << 1;
  X_2 >>= 31;
  ...
  X_3 = leftmost_one | (leftmost_one << 16);
  X_3 |= X_3 << 4;
  X_3 |= X_3 << 2;
  X_3 |= X_3 << 1;
  X_3 >>= 31;
  ...
  X_4 = leftmost_one | (leftmost_one << 8);
  X_4 |= X_4 << 4;
  X_4 |= X_4 << 2;
  X_4 |= X_4 << 1;
  X_4 >>= 31;
